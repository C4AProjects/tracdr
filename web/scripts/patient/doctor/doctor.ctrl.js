 ...
 */
APP.controller('PatientCtrl', function ($scope, $state,$rootScope,$animate,registerService,Notification,$http,ngDialog) {
    $scope.patiens=[]
    $scope.loadPatients=function(){
        $http.get(serverApi + '/secured/doctors/'+$rootScope.USER.patient._id).success(function (res) {
            if (!res.error) {
